...
fdescribe("MyWorkComponent", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [MyWorkComponent, ECLTableStubComponent],
      providers: [
        DnbService,
        StorageService,
        DnbRoleAuthService,
  ...
  it("should navigate to new version", () => {
    ...
    component.versionEditClick({ row: item });
  ...
  it("re assig editor", () => {
    const spy = spyOn(dnbService, "reassignEditor").and.returnValue(of({}));
  ...
  it("re assig approver", () => {
    ...
    component.approverTable.loadData = (value) => {};
